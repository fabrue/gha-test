...
inputs = {
  ...
  # Prod bucket is required here. Therefore do not use Terragrunts dependency feature
  s3_bucket_arn          = "arn:aws:s3:::${basename(get_terragrunt_dir())}.data.prod.tt.apollo.tom-tailor.com"
