...
dependency "s3_source" {
  config_path = "../../datasync_location_s3/prod/data-lake-store-files"
...
dependency "s3_destination" {
  config_path = "../../datasync_location_s3/lab/data-lake-store-files"
...
inputs = {
  ...
  name                     = "data-lake-store-files-prod-to-lab"
}
