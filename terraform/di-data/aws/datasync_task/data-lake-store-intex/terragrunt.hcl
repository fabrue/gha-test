...
dependency "s3_source" {
  config_path = "../../datasync_location_s3/prod/data-lake-store-navision_dwh"
...
dependency "s3_destination" {
  config_path = "../../datasync_location_s3/lab/data-lake-store-navision_dwh"
...
inputs = {
  ...
  name                     = "data-lake-store-intex-prod-to-lab"
}
