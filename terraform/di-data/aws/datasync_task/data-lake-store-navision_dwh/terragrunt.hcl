...
dependency "s3_source" {
  config_path = "../../datasync_location_s3/prod/data-lake-store-intex"
...
dependency "s3_destination" {
  config_path = "../../datasync_location_s3/lab/data-lake-store-intex"
...
inputs = {
  ...
  name                     = "data-lake-store-navision_dwh-prod-to-lab"
}
