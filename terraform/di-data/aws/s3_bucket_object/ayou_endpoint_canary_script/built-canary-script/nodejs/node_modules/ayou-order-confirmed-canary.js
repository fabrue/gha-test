...
const fetchPasswordFromSsm = async () => {
    const password = await ssm.getParameter({Name: '/aboutyou/webhook/order-confirmed/password', WithDecryption: true}).promise();
...
const apiCanaryBlueprint = async function () {
    ...
    const requestOptions = {
        hostname: 'ayou-webhook.data.prod.tt.apollo.tom-tailor.com',
        port: 443,
